...
%       stepSize = (2 - beta1)*stepSize;
%    else
%       stepSize = beta1*stepSize;
%    end
   ...
   optimValues.fval = fEstCost;
    ...
    disp([ num2str(nIter) ': fval ' num2str(fval), ', max grad ' num2str(max(abs(optimValues.gradient))) ', stepsize ' num2str(max(abs(vfStep))) ])
